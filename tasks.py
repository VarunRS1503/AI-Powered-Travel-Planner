...
class TravelTasks:
    ...
    def plan_itinerary(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output="A detailed 7-day travel itinerary including daily plans, recommendations, and practical information."
        )
    ...
    def gather_city_info(self, agent, city, travel_dates, interests):
        ...
        """
            ...
            agent=agent,
            expected_output="An in-depth city guide with information on attractions, customs, events, and recommendations."
        )